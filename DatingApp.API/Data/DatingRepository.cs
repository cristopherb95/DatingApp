...
namespace DatingApp.API.Data
{
  public class DatingRepository : IDatingRepository
  {
    ...
    public async Task<PagedList<User>> GetUsers(UserParams userParams)
    {
      ...
      if (!userParams.Likees && !userParams.Likers) // Same gender not displaying on list view in SPA fix
    ...
    //////////////////////////////////////////////////////// Just for practice
    // private IEnumerable<int> GetUserLikesAlternative(int id, bool likers)
    // {
